...
public class demande_don {
  ...
  private String etat;
    ...
    public demande_don(int id_demande_don, int id_utilisateur, int id_don, Date date_demande, String justificatif_handicap, String type_produit_demande, String Remarques, String etat) {
