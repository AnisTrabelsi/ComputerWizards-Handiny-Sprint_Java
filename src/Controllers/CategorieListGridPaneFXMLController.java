...
public class CategorieListGridPaneFXMLController implements Initializable {
    ...
    public void loadData(){
        ...
        categories.forEach((c) -> {
            ...
            fxmlloader.setLocation(getClass().getResource("/gui_handiny/CategorieGridFXML.fxml"));
            Pane pane;
    ...
    private void sujetReadAll(MouseEvent event) {
        try {
            Parent root = FXMLLoader.load(getClass().getResource("/gui_handiny/SujetListFXML.fxml"));
    ...
    private void addCategorie(MouseEvent event) {
        try {
            Parent root = FXMLLoader.load(getClass().getResource("/gui_handiny/CategorieFXML.fxml"));
            Scene scene = new Scene(root);
            Stage stage = (Stage) ((Node) event.getSource()).getScene().getWindow();
            stage.setScene(scene);
            stage.show();
