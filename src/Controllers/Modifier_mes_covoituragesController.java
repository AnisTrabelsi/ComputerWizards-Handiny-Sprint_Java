 ...
 * @author abbes
 */
public class Modifier_mes_covoituragesController implements Initializable {
Utilisateur u=Utilisateur.getCurrent_user();
    ...
    public void initialize(URL url, ResourceBundle rb) {
                  //      utilisateur u = new utilisateur(1, "mohamed", "benabbes", "09638420", "mohamed.benabbes@esprit.tn", "24076282", "aaa", "aaaa", new Date(2020, 25, 01), "tounes", 2086, "user", "sdsdsd");
    ...
    tfnbr.textProperty().addListener((observable, oldValue, newValue) -> {
      ...
      vb.getChildren().clear();
        ...
        try {
            l = ser.findById(u.getId_utilisateur());
