...
public class SujetListFXMLController implements Initializable {
    ...
    private void addsujet(MouseEvent event) {
        try {
            Parent root = FXMLLoader.load(getClass().getResource("/gui_handiny/SujetFXML.fxml"));
    ...
    private void commentsReadAll(MouseEvent event) {
         try {
            Parent root = FXMLLoader.load(getClass().getResource("/gui_handiny/CommentaireListFXML.fxml"));
            Scene scene = new Scene(root);
            Stage stage = (Stage) ((Node) event.getSource()).getScene().getWindow();
            stage.setScene(scene);
            stage.show();
