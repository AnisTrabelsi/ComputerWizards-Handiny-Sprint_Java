...
public class FrontController implements Initializable {
  ...
  @FXML
    ...
    @FXML
    private void AffichageReservations(ActionEvent event) throws IOException {
          AnchorPane pane = FXMLLoader.load(getClass().getResource("/gui_handiny/AffichageLocation.fxml"));
           mesDons.getChildren().setAll(pane);
    }
