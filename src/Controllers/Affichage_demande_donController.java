...
vb.getChildren().clear();
     List<demande_don> l = new ArrayList<demande_don>();
        Service_demande_don ser = new Service_demande_don();
        try {
            l = ser.sort_date_demande_don_of_user(Utilisateur.getCurrent_user().getId_utilisateur());
        } catch (SQLException ex) {
            System.out.println(ex);
        }
        ///////////////////////////////////////////////user
...
/////////////////////////////////////////////////
    ...
    @FXML
    private void pdf(ActionEvent event) throws IOException, FileNotFoundException, DocumentException, BadElementException, InterruptedException, SQLException {
                     List<demande_don> l = new ArrayList<demande_don>();
        Service_demande_don ser = new Service_demande_don();
        try {
            l = ser.readAll_demande_don();
