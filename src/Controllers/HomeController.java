...
label.setFont(new Font(32));
   ...
   private Map<String, Double> getDataMap() throws SQLException {
    ...
    @FXML
    private void demandes_reservations(ActionEvent event) throws IOException {
        AnchorPane pane = FXMLLoader.load(getClass().getResource("/gui/AffichageLocations_Proprietaire_voiture.fxml"));
           rootpane.getChildren().setAll(pane);
    }
}
