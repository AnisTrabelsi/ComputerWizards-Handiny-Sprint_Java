...
public class Reservation_Chauffeur {
    ...
    public Reservation_Chauffeur(int id_reservation_chauffeur, int id_chauffeur,int duree_service, String date_prise_en_charge, String description_demande) {
  ...
  public Reservation_Chauffeur( int duree_service, String date_prise_en_charge, String description_demande) {
